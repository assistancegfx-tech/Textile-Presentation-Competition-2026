...
/**
 * 📄 SHARED ENTRY VOUCHER PDF RETRIEVER & GENERATOR
 ...
 */
function buildEntryVoucherPdf(details) {
        ...
        if (resp.getResponseCode() === 200) {
          ...
          if (parsed && parsed.base64 && parsed.base64.length > 100) {
            ...
            if (decoded && decoded.length > 0) {
              ...
              Logger.log("[WEBSITE jsPDF SUCCESS] Attached fresh " + targetStatus + " voucher for " + regId);
              return pdfBlob;
            }
          }
        }
        ...
        if (resp.getResponseCode() === 200) {
          ...
          if (parsed && parsed.base64 && parsed.base64.length > 100) {
            ...
            if (decoded && decoded.length > 0) {
              ...
              Logger.log("[WEBSITE GET PDF SUCCESS] Attached fresh " + targetStatus + " voucher for " + regId);
              return pdfBlob;
            }
          }
        }
